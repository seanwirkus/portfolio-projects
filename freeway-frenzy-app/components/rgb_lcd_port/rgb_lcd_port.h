...
#define EXAMPLE_LCD_PIXEL_CLOCK_HZ      (18.0 * 1000 * 1000) ///< Pixel clock frequency in Hz
...
#define EXAMPLE_RGB_BOUNCE_BUFFER_SIZE  (EXAMPLE_LCD_H_RES * 10) ///< Original stable value
